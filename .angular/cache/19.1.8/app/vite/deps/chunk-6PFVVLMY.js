...
function forkJoin() {
  ...
  var _a4 = argsArgArrayOrObject(args), sources = _a4.args, keys = _a4.keys;
...
function fromEvent(target, eventName, options, resultSelector) {
  ...
  }) : isNodeStyleEventEmitter(target) ? nodeEventEmitterMethods.map(toCommonHandlerRegistry(target, eventName)) : isJQueryStyleEventEmitter(target) ? jqueryMethods.map(toCommonHandlerRegistry(target, eventName)) : [], 2), add = _a4[0], remove2 = _a4[1];
  if (!add) {
...
function resource(options) {
  ...
  return new ResourceImpl(request, options.loader, void 0, options.equal ? wrapEqualityFn(options.equal) : void 0, (_b2 = options.injector) != null ? _b2 : inject(Injector));
}
    ...
    this.state = linkedSignal({
      ...
      computation: (status, previous) => {
        ...
        return {
          ...
          previousStatus: (_a4 = previous == null ? void 0 : previous.value.status) != null ? _a4 : ResourceStatus.Idle,
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-6PFVVLMY.js.map
