...
var _SharedResizeObserver = class _SharedResizeObserver {
  ...
  ngOnDestroy() {
    ...
    (_a = this._cleanupErrorListener) == null ? void 0 : _a.call(this);
  }
  /**
...
var _MatFormField = class _MatFormField {
  ...
  ngOnDestroy() {
    var _a, _b, _c;
    (_a = this._stateChanges) == null ? void 0 : _a.unsubscribe();
    (_b = this._valueChanges) == null ? void 0 : _b.unsubscribe();
    (_c = this._describedByChanges) == null ? void 0 : _c.unsubscribe();
    this._destroyed.next();
    this._destroyed.complete();
  }
  /**
  ...
  _initializeControl(previousControl) {
    ...
    (_b = this._describedByChanges) == null ? void 0 : _b.unsubscribe();
  ...
  _updateOutlineLabelOffset() {
    ...
    const iconPrefixContainerWidth = (_e = iconPrefixContainer == null ? void 0 : iconPrefixContainer.getBoundingClientRect().width) != null ? _e : 0;
    const textPrefixContainerWidth = (_f = textPrefixContainer == null ? void 0 : textPrefixContainer.getBoundingClientRect().width) != null ? _f : 0;
    const iconSuffixContainerWidth = (_g = iconSuffixContainer == null ? void 0 : iconSuffixContainer.getBoundingClientRect().width) != null ? _g : 0;
...
//# sourceMappingURL=chunk-YGJ4WUPV.js.map
