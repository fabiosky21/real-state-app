...
} from "./chunk-EZUCNLAN.js";
import {
  ScrollDispatcher,
  ScrollingModule,
  ViewportRuler
} from "./chunk-VXS7DIN5.js";
import {
  Platform,
...
} from "./chunk-IQRBRLKT.js";
import {
  BidiModule,
  Directionality
} from "./chunk-PSQL2EPK.js";
import {
  DOCUMENT,
  Location
} from "./chunk-AQLC6AMV.js";
import {
...
var _OverlayKeyboardDispatcher = class _OverlayKeyboardDispatcher extends BaseOverlayDispatcher {
  ...
  detach() {
    var _a;
    if (this._isAttached) {
      (_a = this._cleanupKeydown) == null ? void 0 : _a.call(this);
...
var _OverlayOutsideClickDispatcher = class _OverlayOutsideClickDispatcher extends BaseOverlayDispatcher {
  ...
  detach() {
    var _a;
    if (this._isAttached) {
      (_a = this._cleanups) == null ? void 0 : _a.forEach((cleanup) => cleanup());
...
var BackdropRef = class {
  ...
  dispose = () => {
    ...
    (_b = this._cleanupTransitionEnd) == null ? void 0 : _b.call(this);
...
var OverlayRef = class {
  ...
  get backdropElement() {
    var _a;
    return ((_a = this._backdropRef) == null ? void 0 : _a.element) || null;
  }
  /**
  ...
  attach(portal) {
    ...
    (_a = this._afterNextRenderRef) == null ? void 0 : _a.destroy();
  ...
  dispose() {
    ...
    (_a = this._backdropRef) == null ? void 0 : _a.dispose();
    this._locationChanges.unsubscribe();
    this._keyboardDispatcher.remove(this);
    ...
    this._outsideClickDispatcher.remove(this);
    (_b = this._host) == null ? void 0 : _b.remove();
    ...
    if (!this._animationsDisabled && typeof requestAnimationFrame !== "undefined") {
      this._ngZone.runOutsideAngular(() => {
        requestAnimationFrame(() => {
          var _a2;
          return (_a2 = this._backdropRef) == null ? void 0 : _a2.element.classList.add(showingClass);
        });
      });
    } else {
  ...
  detachBackdrop() {
    ...
    if (this._animationsDisabled) {
      ...
      (_b = this._backdropRef) == null ? void 0 : _b.detach();
    }
  }
  ...
  _disposeScrollStrategy() {
    ...
    (_a = scrollStrategy == null ? void 0 : scrollStrategy.detach) == null ? void 0 : _a.call(scrollStrategy);
  }
};
...
var _CdkConnectedOverlay = class _CdkConnectedOverlay {
  ...
  ngOnDestroy() {
    ...
    (_a = this._overlayRef) == null ? void 0 : _a.dispose();
  }
  ngOnChanges(changes) {
    var _a;
    if (this._position) {
      this._updatePositionStrategy(this._position);
      (_a = this._overlayRef) == null ? void 0 : _a.updateSize({
        width: this.width,
  ...
  detachOverlay() {
    var _a;
    (_a = this._overlayRef) == null ? void 0 : _a.detach();
    this._backdropSubscription.unsubscribe();
    this._positionSubscription.unsubscribe();
    this.open = false;
  }
...
var _FullscreenOverlayContainer = class _FullscreenOverlayContainer extends OverlayContainer {
  ...
  ngOnDestroy() {
    var _a;
    super.ngOnDestroy();
    (_a = this._cleanupFullScreenListener) == null ? void 0 : _a.call(this);
  }
  _createContainer() {
    var _a;
...
//# sourceMappingURL=chunk-R262I6LY.js.map
