  ...
  if (!n || !BUILD.hotModuleReplacement) {
    ...
    switch (a) {
      case "pwa-action-sheet":
        return import("./pwa-action-sheet.entry-OBM7R4LL.js").then(s, consoleError);
      case "pwa-camera-modal":
        return import("./pwa-camera-modal.entry-HI3TIVWT.js").then(s, consoleError);
      case "pwa-toast":
        return import("./pwa-toast.entry-SJOUEKFV.js").then(s, consoleError);
      case "pwa-camera-modal-instance":
        return import("./pwa-camera-modal-instance.entry-FZ2YK3JB.js").then(s, consoleError);
      case "pwa-camera":
        return import("./pwa-camera.entry-ZHISDF4A.js").then(s, consoleError);
    }
  }
...
//# sourceMappingURL=chunk-7EV2S4Y3.js.map
